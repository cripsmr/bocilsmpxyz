...
export const metadata: Metadata = {
    ...
    metadataBase: new URL("https://bocilsmp.xyz"),
    alternates: {
        canonical: `/`,
    },
    openGraph: {
    ...
    verification: {
        google: 'OkPM3i2Dup4wdRnRhyYaCHf5DjlAYc9jeF38T8KvFeI',
        yandex: '',
    },
};
...
export default function RootLayout({
    ...
    const jsonLd = {
        ...
        "name": `${SITENAME}`,
        "description": `${SITENAME} Video Bokep Indo Jepang Jav Barat Simontok Viral Terbaru Bocil Ngentot Jilbab Smp Mama Sma korea china tante live paksa ngentot abg cewek pelajar.`,
        "logo": "https://bocilsmp.xyz/favicon.ico",
        "url": "https://bocilsmp.xyz",
        "founder":{
            "@type":"Person",
            "name":"admin",
            "url":"https://bocilsmp.xyz"
        ...
        "url": "https://bocilsmp.xyz",
        "description": `${SITENAME} Video Bokep Indo Jepang Jav Barat Simontok Viral Terbaru Bocil Ngentot Jilbab Smp Mama Sma korea china tante live paksa ngentot abg cewek pelajar.`,
        "image": "https://bocilsmp.xyz/favicon.ico",
        "potentialAction":{
            "@type":"ReadAction",
            "target":"https://bocilsmp.xyz"}
        }
        const jsonLd2 = {
            "@context": "https://schema.org",
        "@type": "WebSite",
        ...
        "potentialAction": { 
        "@type": "SearchAction", 
          "target": "https://bocilsmp.xyz/?q={search_term}", 
